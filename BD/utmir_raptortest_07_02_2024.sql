...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2024 a las 20:46:43
...
(9, NULL, 'ELEPEPE', 57),
(10, NULL, 'estructura de mater', 59),
(11, NULL, 'asdas', 58);
...
INSERT INTO `utmir_planeaciones` (`id_planeacion`, `descripcion`, `fecha`, `no_semana`, `id_asignacion_asignatura`) VALUES
(4, 'PLANEACION 1 ', '2024-02-07', '1', 57),
(5, 'PLANEACION 2', '2024-02-07', '2', 57),
(6, 'PRIMERA DE LA SRGUNDA MATEROA', '2024-02-13', '1', 58),
(7, 'PLANEACION 3 TESTTTTTTTTT', '2024-02-06', '3', 57),
(8, 'sadasd', '2024-02-05', '4', 57),
(9, 'FECHAHASHASAS', '2024-02-07', '1', 23),
(10, 'LISTA', '2024-02-12', '5', 57),
(11, 'EWEQWAWE', '2024-02-08', '6', 57),
(12, 'assad', '2024-02-23', '6', 57),
(13, 'SSSWEEEXXX', '2024-02-14', '7', 57),
(14, 'el,pepe', '2024-02-08', '8', 57),
(15, 'pepete', '2024-02-28', '9', 57),
(16, 'asda', '2024-02-14', '10', 57),
(17, 'SEMANA 11', '2024-02-28', '11', 57),
(18, 'primera de tercera', '2024-02-12', '1', 59),
(19, 'Introducción a la asignatura', '2024-02-15', '12', 57);
...
--
ALTER TABLE `utmir_asignacion_asignatura`
  MODIFY `id_asignacion_asignatura` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `utmir_fecha_unidades`
  MODIFY `id_fechas_unidades` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `utmir_objetivos_asignatura`
  MODIFY `id_objetivo_asignatura` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `utmir_planeaciones`
  MODIFY `id_planeacion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
