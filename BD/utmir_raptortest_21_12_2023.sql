...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-12-2023 a las 02:24:38
...
INSERT INTO `utmir_cuotas` (`id_cuota`, `cuota`, `formato_numerico_cuota`) VALUES
(1, 'Inscripción', '01'),
(2, 'Reinscripción', '02'),
(3, 'Readmisión', '03'),
(4, 'Trámite de equivalencia de estudios', '04'),
(5, 'Examen de ingreso a la educación superior', '05'),
(6, 'Examen remedial', '06'),
(7, 'Examen de certificación de lengua extranjera', '07'),
(8, 'Credencial de identificación escolar', '08'),
(9, 'Constancia escolar', '09'),
(10, 'Historial Académico', '10'),
(11, 'Certificado de estudios', '11'),
(12, 'Seguro estudiantil contra accidentes', '12'),
(13, 'Titulación', '13'),
(14, 'Derecho por la validación electrónica de título profesional mediante medidas de seguridad (timbre holograma)', '14'),
(15, 'Protocolo de titulación', '15'),
(16, 'Expedición de Registro Estatal', '16'),
(17, 'Curso propedéutico', '17'),
(18, 'Servicios de Educación Continua Básico', '18'),
(19, 'Servicios de Educación Continua Intermedio', '19'),
(20, 'Servicios de Educación Continua Avanzado', '20'),
(21, 'Servicios de Educación Continua Especializado', '21'),
(22, 'Reposición de credencial', '22'),
(23, 'Póliza de mantenimiento y servicio técnico', '23'),
(24, 'Aportación mensual de cafetería', '24'),
(25, 'Aportación por publicidad', '25'),
(26, 'Concesión de maquinas despachadoras de alimentos', '26'),
(27, 'Copia fotostática', '27'),
(28, 'Cuota de recuperación por impresión en blanco y negro', '28'),
(29, 'Cuota por uso de la cancha de fútbol soccer', '29'),
(30, 'Cuota de recuperación para el mantenimiento por el uso de espacios universitarios administrativos y usos múltiples. (Para eventos externos)', '30'),
(31, 'Cuota de recuperación para el mantenimiento de uso de casillero', '31'),
(32, 'Cuota por pago extemporáneo por inscripción o reinscripción', '32'),
(33, 'Reposición de pase de estacionamiento', '33'),
(34, 'Cuota por devolución extemporánea de acervo bibliográfico por día', '34'),
(35, 'Paquete (1) Inscripción con recargos', '35'),
(36, 'Paquete (2) Reinscripción con recargos', '36'),
(37, 'mixta (varios pagos)', '37'),
(38, 'Paquete (3) Titulación, Certificado, Derecho por la validación electrónica y expedición de registro', '38'),
(39, 'Paquete (4) Certificado y titulación', '39'),
(40, 'Paquete (5) inscripción ( inscripción, seguro, credencial, curso propedéutico', '40'),
(41, 'Paquete (6) inscripción (inscripción, seguro, credencial, curso propedéutico) (con recargos)', '41'),
(42, 'Paquete (7) Derecho val. Electrónica y expedición de registro estatal', '42'),
(43, 'Paquete (8) Reinscripción, credencial, seguro estudiantil', '43'),
(44, 'Paquete (9) Paquete reinscripción, inscripción, credencial, seguro estudiantil (con recargo)', '44'),
(45, 'Paquete (10) Inscripcion y credencial', '45'),
(46, 'Paquete (11) Reinscripcion y certificado', '46'),
(47, 'Paquete (12) reinscripcion y certificado (con recargo)', '47'),
(48, 'Paquete (13) Titulacion,Validación y Registro', '48'),
(49, 'Paquete (14) INSCRIPCIÓN, CREDENCIAL, SEGURO Y CERTIFICADO', '49'),
(50, 'Paquete (15) PAGO DE TITULACIÓN (TITULACIÓN, PROTOCOLO DE TITULACIÓN, CERTIFICADO, VALIDACIÓN,REGISTRO)', '50'),
(51, 'Paquete (16) PAGO DE TITULACIÓN (protocolo, validación, registro)', '51'),
(52, 'Paquete (17) TITULACIÓN (titulación,protocolo, validación, registro )', '52');
...
('2303022', 'MAYUS', 'MAYUS', 'OPPOO', '24', 'ooop@gmail.com', '2001-02-12', 'as', 'MAYUS', 'mayus', NULL, '771523315', '$2a$10$kf..PlN.eZUqFflKeR3dRekfx5Z1d5wlHOgA5Jzrj5OVw1nLtjCmm', NULL, 18, 1, 1, NULL, '1', '2023-12-21'),
('2303023', NULL, NULL, 'ksajdsaosad', NULL, 'gdgd@sks.com', NULL, NULL, NULL, NULL, NULL, NULL, '$2a$10$BxYsSRvBMuNbbswJrZLieuga.imnZaYg5HzfMGWke2RieA6.saInW', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-19'),
('2303024', NULL, NULL, 'OWROEWO', NULL, 'noelinarte@utmir.edu.mx', NULL, NULL, NULL, NULL, NULL, NULL, '$2a$10$J2jGCg5g8Fk/XkEh6mx9SO1ev72WKiw.D3qkl0MRCRVWRswfBnbDm', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-21');
...
(25, '2303021', 5, '302104053', NULL, 'no'),
(26, '2303022', 5, '302212053', NULL, NULL);
...
--
ALTER TABLE `utmir_antecedentes_academicos`
  MODIFY `id_antecedentes_academicos` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `utmir_contacto_emergencia`
  MODIFY `id_contacto_emergencia` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `utmir_datos_generales`
  MODIFY `id_datos_generales` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `utmir_informacion_medica`
  MODIFY `id_info_medica` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
