...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2024 a las 20:59:38
...
CREATE TABLE `utmir_planeaciones` (
  ...
  `id_asignatura` bigint(20) DEFAULT NULL,
  `matricula_docente` varchar(255) DEFAULT NULL,
  `id_grupo` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `utmir_planeaciones` (`id_planeacion`, `descripcion`, `fecha`, `no_semana`, `id_asignatura`, `matricula_docente`, `id_grupo`) VALUES
(1, 'Introducción a la asignatura', '2024-02-15', '1', 12, '198', 1),
(2, 'Introducción a la asignatura', '2024-02-15', '2', 12, '198', 1);
...
ALTER TABLE `utmir_planeaciones`
  ...
  ADD KEY `FKeb4bddmna4bx99kwpf3exeii3` (`id_asignatura`),
  ADD KEY `FKmqtvxmqqwjju1v5od52li3ei9` (`matricula_docente`),
  ADD KEY `FKkmrmvyjotxv4h7tmf0talbo4p` (`id_grupo`);
...
--
ALTER TABLE `utmir_asignacion_asignatura`
  MODIFY `id_asignacion_asignatura` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `utmir_fecha_unidades`
  MODIFY `id_fechas_unidades` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `utmir_planeaciones`
  MODIFY `id_planeacion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `utmir_planeaciones`
  ADD CONSTRAINT `FKeb4bddmna4bx99kwpf3exeii3` FOREIGN KEY (`id_asignatura`) REFERENCES `utmir_asignatura` (`id_asignaturas`),
  ADD CONSTRAINT `FKkmrmvyjotxv4h7tmf0talbo4p` FOREIGN KEY (`id_grupo`) REFERENCES `utmir_grupos` (`id`),
  ADD CONSTRAINT `FKmqtvxmqqwjju1v5od52li3ei9` FOREIGN KEY (`matricula_docente`) REFERENCES `utmir_info_personal` (`matricula`);
