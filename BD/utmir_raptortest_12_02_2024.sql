...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-02-2024 a las 21:04:53
...
CREATE TABLE `utmir_fecha_unidades` (
  ...
  `clases_activa` varchar(255) DEFAULT NULL,
...
INSERT INTO `utmir_fecha_unidades` (`id_fechas_unidades`, `clases_activa`, `fecha_cierre`, `fecha_inicio`, `status`, `matricula`, `id_unidades_asignatura`, `fecha_remedial`, `id_grupo`) VALUES
(13, 'Activa', '2024-02-29', '2024-01-30', b'1', '198', 21, '2024-03-04', 2),
(14, 'Activa', '2024-01-23', '2024-01-30', b'1', '198', 22, '2024-02-01', 2),
(15, 'Activa', '2024-02-10', '2024-02-03', b'1', '71', 842, '2024-02-01', 1),
(16, 'Activa', '2024-03-01', '2024-02-21', b'1', '198', 18, '2024-03-01', 2),
(17, 'Activa', '2024-02-23', '2024-02-09', b'1', '198', 20, '2024-02-28', 2),
(18, 'Activa', '2024-02-29', '2024-02-08', b'1', '198', 321, '2024-02-23', 2),
(19, 'Activa', '2024-02-10', '2024-02-09', b'1', '71', 802, '2024-02-16', 1),
(20, 'Activa', '2024-02-16', '2024-02-10', b'1', '198', 323, '2024-02-15', 2),
(21, 'Activa', NULL, NULL, b'1', '198', 19, NULL, 2);
...
--
ALTER TABLE `utmir_asignacion_asignatura`
  MODIFY `id_asignacion_asignatura` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `utmir_clase_asignatura`
  MODIFY `id_horarios_clase` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `utmir_fecha_unidades`
  MODIFY `id_fechas_unidades` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `utmir_planeaciones`
  MODIFY `id_planeacion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
